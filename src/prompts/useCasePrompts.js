...
4. Create appointment with staff name`,
  ...
  hairdresser_services: {
    tr: `## Kuaför Randevusu
1. İstenen hizmeti öğren (saç kesimi, boyama, fön)
2. Kuaför tercihi olup olmadığını sor (önemli!)
3. Hizmet süresini ve fiyatını belirt
