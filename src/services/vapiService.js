...
function getToolStartMessage(toolName, language) {
  // Doğal, konuşma dilinde mesajlar - "..." ile biten cümleler TTS'de daha yumuşak okunur
  const messages = {
    tr: {
      // Automotive tools
      get_available_time_slots: 'Müsait saatleri kontrol ediyorum...',
      get_available_vehicles: 'Hemen araçlara bakıyorum...',
      create_test_drive_appointment: 'Randevunuzu hemen oluşturuyorum...',
      ...
      get_business_info: 'Bir saniye...',
      get_working_hours: 'Çalışma saatlerine bakıyorum...',
      get_service_price: 'Fiyat bilgisine bakıyorum...',
      get_customer_history: 'Geçmiş bilgilerinize bakıyorum...',
      get_active_promotions: 'Güncel kampanyalara bakıyorum...',
      get_loyalty_points: 'Puan bilginizi kontrol ediyorum...',
      apply_promo_code: 'Kodu kontrol ediyorum...',
      submit_complaint: 'Geri bildiriminizi kaydediyorum...',
      // Beauty/Hairdresser tools
      get_beauty_services: 'Hizmetlere bakıyorum...',
      get_hairdresser_services: 'Hizmetlere bakıyorum...',
      create_beauty_appointment: 'Randevunuzu hemen oluşturuyorum...',
      get_available_staff: 'Müsait personellere bakıyorum...',
      book_with_staff: 'Randevunuzu hemen oluşturuyorum...',
      default: 'Bir saniye...',
    },
    en: {
      // Automotive tools
      get_available_time_slots: 'Checking available times...',
      get_available_vehicles: 'Checking available vehicles...',
      create_test_drive_appointment: 'Creating your appointment right away...',
      ...
      get_business_info: 'One moment...',
      get_working_hours: 'Checking the working hours...',
      get_service_price: 'Looking up the price...',
      get_customer_history: 'Looking up your history...',
      get_active_promotions: 'Checking current promotions...',
      get_loyalty_points: 'Checking your points...',
      apply_promo_code: 'Verifying the code...',
      submit_complaint: 'Recording your feedback...',
      // Beauty/Hairdresser tools
      get_beauty_services: 'Looking up services...',
      get_hairdresser_services: 'Looking up services...',
      create_beauty_appointment: 'Creating your appointment right away...',
      get_available_staff: 'Checking available staff...',
      book_with_staff: 'Creating your appointment right away...',
      default: 'One moment...',
    },
    de: {
      // Automotive tools
      get_available_time_slots: 'Ich prüfe die verfügbaren Zeiten...',
      get_available_vehicles: 'Ich schaue gleich nach den Fahrzeugen...',
      create_test_drive_appointment: 'Ich erstelle sofort Ihren Termin...',
      ...
      get_business_info: 'Einen Moment...',
      get_working_hours: 'Ich schaue nach den Arbeitszeiten...',
      get_service_price: 'Ich schaue nach dem Preis...',
      get_customer_history: 'Ich schaue in Ihre Historie...',
      get_active_promotions: 'Ich schaue nach den aktuellen Aktionen...',
      get_loyalty_points: 'Ich prüfe Ihren Punktestand...',
      apply_promo_code: 'Ich prüfe den Code...',
      submit_complaint: 'Ich speichere Ihr Feedback...',
      // Beauty/Hairdresser tools
      get_beauty_services: 'Ich schaue nach den Dienstleistungen...',
      get_hairdresser_services: 'Ich schaue nach den Dienstleistungen...',
      create_beauty_appointment: 'Ich erstelle sofort Ihren Termin...',
      get_available_staff: 'Ich schaue nach dem verfügbaren Personal...',
      book_with_staff: 'Ich erstelle sofort Ihren Termin...',
 ...
 */
function getToolFailMessage(toolName, language) {
  // Tool bazlı hata mesajları — daha doğal ve context-aware
  const messages = {
    tr: {
      get_available_vehicles: 'Şu an sisteme ulaşamadım, birazdan tekrar deneyebilir miyiz?',
      create_test_drive_appointment: 'Randevu oluştururken bir sorun yaşadım, tekrar deneyebilir miyiz?',
      create_service_appointment: 'Randevu oluştururken bir sorun yaşadım, tekrar deneyebilir miyiz?',
      get_service_price: 'Fiyat bilgisine şu an ulaşamadım, başka nasıl yardımcı olabilirim?',
      get_business_info: 'Bilgilere şu an ulaşamadım, başka bir konuda yardımcı olabilir miyim?',
      get_working_hours: 'Saatlere şu an ulaşamadım, başka nasıl yardımcı olabilirim?',
      get_available_time_slots: 'Saatlere şu an ulaşamadım, başka bir tarih deneyelim mi?',
      get_my_appointments: 'Randevulara şu an ulaşamadım, biraz sonra tekrar deneyebilir miyiz?',
      cancel_appointment: 'İptal işleminde bir sorun yaşadım, tekrar deneyebilir miyiz?',
      reschedule_appointment: 'Güncelleme sırasında bir sorun yaşadım, tekrar deneyebilir miyiz?',
      get_active_promotions: 'Kampanya bilgilerine şu an ulaşamadım, başka nasıl yardımcı olabilirim?',
      submit_complaint: 'Kaydederken bir sorun yaşadım, lütfen tekrar dener misiniz?',
      // Beauty/Hairdresser tools
      create_beauty_appointment: 'Randevu oluştururken bir sorun yaşadım, tekrar deneyebilir miyiz?',
      get_beauty_services: 'Hizmet bilgilerine şu an ulaşamadım, birazdan tekrar deneyebilir miyiz?',
      get_hairdresser_services: 'Hizmet bilgilerine şu an ulaşamadım, birazdan tekrar deneyebilir miyiz?',
      get_available_staff: 'Personel bilgilerine şu an ulaşamadım, birazdan tekrar deneyebilir miyiz?',
      book_with_staff: 'Randevu oluştururken bir sorun yaşadım, tekrar deneyebilir miyiz?',
      default: 'Şu an buna ulaşamadım, başka bir konuda yardımcı olabilir miyim?',
    },
    en: {
      get_available_vehicles: "I couldn't reach the system right now, can we try again in a moment?",
      create_test_drive_appointment: 'There was an issue creating the appointment, can we try again?',
      create_service_appointment: 'There was an issue creating the appointment, can we try again?',
      get_service_price: "I couldn't get the price right now, how else can I help?",
      get_business_info: "I couldn't get that information right now, can I help with something else?",
      get_working_hours: "I couldn't get the hours right now, how else can I help?",
      get_available_time_slots: "I couldn't check the times, would you like to try a different date?",
      get_my_appointments: "I couldn't reach your appointments right now, can we try again shortly?",
      cancel_appointment: 'There was an issue cancelling, can we try again?',
      reschedule_appointment: 'There was an issue updating, can we try again?',
      get_active_promotions: "I couldn't get the promotions right now, how else can I help?",
      submit_complaint: 'There was an issue recording that, could you try again?',
      create_beauty_appointment: 'There was an issue creating the appointment, can we try again?',
      get_beauty_services: "I couldn't get the services right now, can we try again in a moment?",
      get_hairdresser_services: "I couldn't get the services right now, can we try again in a moment?",
      get_available_staff: "I couldn't check staff availability right now, can we try again?",
      book_with_staff: 'There was an issue creating the appointment, can we try again?',
      default: "I couldn't get that information right now, is there anything else I can help with?",
    },
    de: {
      get_available_vehicles: 'Das System ist gerade nicht erreichbar, können wir es gleich nochmal versuchen?',
      create_test_drive_appointment: 'Es gab ein Problem beim Erstellen des Termins, können wir es nochmal versuchen?',
      create_service_appointment: 'Es gab ein Problem beim Erstellen des Termins, können wir es nochmal versuchen?',
      get_service_price: 'Ich konnte den Preis gerade nicht abrufen, wie kann ich Ihnen sonst helfen?',
      get_business_info: 'Ich konnte die Informationen gerade nicht abrufen, kann ich Ihnen anders helfen?',
      get_working_hours: 'Ich konnte die Arbeitszeiten gerade nicht abrufen, wie kann ich Ihnen sonst helfen?',
      get_available_time_slots: 'Ich konnte die Zeiten nicht prüfen, möchten Sie ein anderes Datum versuchen?',
      get_my_appointments: 'Ich konnte Ihre Termine gerade nicht abrufen, können wir es gleich nochmal versuchen?',
      cancel_appointment: 'Es gab ein Problem bei der Stornierung, können wir es nochmal versuchen?',
      reschedule_appointment: 'Es gab ein Problem beim Aktualisieren, können wir es nochmal versuchen?',
      get_active_promotions: 'Ich konnte die Aktionen gerade nicht abrufen, wie kann ich Ihnen sonst helfen?',
      submit_complaint: 'Es gab ein Problem beim Speichern, könnten Sie es nochmal versuchen?',
      create_beauty_appointment: 'Es gab ein Problem beim Erstellen des Termins, können wir es nochmal versuchen?',
      get_beauty_services: 'Ich konnte die Dienstleistungen gerade nicht abrufen, können wir es gleich nochmal versuchen?',
      get_hairdresser_services: 'Ich konnte die Dienstleistungen gerade nicht abrufen, können wir es gleich nochmal versuchen?',
      get_available_staff: 'Ich konnte die Personalverfügbarkeit gerade nicht prüfen, können wir es nochmal versuchen?',
      book_with_staff: 'Es gab ein Problem beim Erstellen des Termins, können wir es nochmal versuchen?',
      default: 'Das konnte ich gerade nicht abrufen, kann ich Ihnen anders helfen?',
    },
  };
...
function buildAssistantConfig(mergedConfig, tenantInfo, language, tools = []) {
  ...
  const toolDefinitions = tools.map(tool => ({
    ...
    messages: [
      ...
      {
        type: 'request-failed',
        content: getToolFailMessage(tool.name, language),
      },
    ],
  }));
